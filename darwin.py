...
email = str(parser.get('Darwinbox', 'email'))
password = str(parser.get('Darwinbox', 'password'))
mobile = str(parser.get('Darwinbox', 'mobile'))
sms_notif_enable = bool(parser.get('Darwinbox', 'sms_notif_enable'))
value = email.replace('@', '.')
